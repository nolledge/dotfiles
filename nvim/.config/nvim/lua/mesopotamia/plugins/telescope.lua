...
local setup = function()
  ...
  map(
    "n",
    "<leader>fd",
    [[<cmd>lua require("telescope.builtin").find_files({cwd = "~/workspace/dotfiles/nvim/.config/nvim", layout_strategy="vertical"})<CR>]]
  )
  map(
    "n",
    "<leader>ft",
  ...
  map("n", "<space><space>", [[<cmd>lua require("telescope.builtin").buffers()<CR>]])
